...
BINARY_SENSOR_DESCRIPTIONS: tuple[AudiBinarySensorEntityDescription, ...] = (
    ...
    AudiBinarySensorEntityDescription(
        key="climatisation_window_heating_enabled",
        attr_key="climatisation_window_heating_enabled",
        name="Window heating setting",
        icon="mdi:car-defrost-front",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    AudiBinarySensorEntityDescription(
        key="climatisation_at_unlock",
        attr_key="climatisation_at_unlock",
        name="Climatisation at unlock",
        icon="mdi:car-key",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    AudiBinarySensorEntityDescription(
        key="climatisation_zone_front_left",
        attr_key="climatisation_zone_front_left",
        name="Climatisation zone front left",
        icon="mdi:car-seat-heater",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    AudiBinarySensorEntityDescription(
        key="climatisation_zone_front_right",
        attr_key="climatisation_zone_front_right",
        name="Climatisation zone front right",
        icon="mdi:car-seat-heater",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    AudiBinarySensorEntityDescription(
        key="climatisation_zone_rear_left",
        attr_key="climatisation_zone_rear_left",
        name="Climatisation zone rear left",
        icon="mdi:car-seat-heater",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    AudiBinarySensorEntityDescription(
        key="climatisation_zone_rear_right",
        attr_key="climatisation_zone_rear_right",
        name="Climatisation zone rear right",
        icon="mdi:car-seat-heater",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    AudiBinarySensorEntityDescription(
