...
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME, CONF_REGION, CONF_PORT, CONF_SCAN_INTERVAL, CONF_NAME
...
class AudiConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        data_schema[vol.Optional(CONF_SCAN_INTERVAL, default=DEFAULT_UPDATE_INTERVAL)] = int 
